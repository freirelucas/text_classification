...
# prepare one copy to use in LIME
import copy
X_train_lime = copy.deepcopy(X_train)
X_test_lime  = copy.deepcopy(X_test)
...
###  End Section 2 and begin Section 3 ###
...
target_names = ["Prova","Irrelevante"]
...
# y_train, y_test = data_train.target, data_test.target y_ta
...
plt.savefig("Performance from different classifiers", dpi=None, facecolor='w', edgecolor='w',
